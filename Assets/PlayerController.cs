...
public class PlayerController : MonoBehaviour
{
    ...
    const float ceilingCheckDistance = 1f;
    ...
    public void Move(bool crouch, bool jump)
    {
        ...
        rb.velocity = new Vector3((moveVelocityTo.x * (speedReal * 100) * Time.deltaTime), Mathf.Clamp(jumpVelocity, -gravity * 2, maxHieght), (moveVelocityTo.z * (speedReal * 100) * Time.deltaTime));
        rb.velocity = rb.velocity + dashVelocity;

        dashVelocity = Vector3.SmoothDamp(dashVelocity, new Vector3(0, 0, 0), ref reference, 0.1f);
    }
    ...
    public void Dash()
    {
        Debug.Log(moveVelocityTo * 75);
        dashVelocity = moveVelocityTo * 75;
    }
}
